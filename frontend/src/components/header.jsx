...
const Header = () => {
  ...
  // เพิ่มคลาส has-header ให้ body เมื่อ Header render
  useEffect(() => {
          ...
          <div className="pm-right">
            ...
            <div className="pm-dropdown-wrapper">
              ...
              <div
                ...
                role="menu"
              >
                <a href="/orders" role="menuitem" tabIndex={accOpen ? 0 : -1} onClick={() => setAccOpen(false)}>
                  Order History
                </a>
                <a href="/login" role="menuitem" tabIndex={accOpen ? 0 : -1} onClick={() => setAccOpen(false)}>
                  Log Out
                </a>
              </div>
            </div>
